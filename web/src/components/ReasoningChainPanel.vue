...
import { Aim, ArrowDown } from '@element-plus/icons-vue'
import type { DiagnosisFusionResult, DiagnosisOutput, ReasoningStep } from '../types'
...
function layerOutcome(layer: 'llm' | 'mechanical' | 'rules'): string {
  const step = props.result.reasoning_chain.find((s: ReasoningStep) => s.layer === layer)
